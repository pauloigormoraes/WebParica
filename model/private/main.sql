...
-- Fri 01 Jul 2016 03:14:18 PM AMT
...
CREATE TABLE IF NOT EXISTS `parica_db`.`contato` (
  ...
  `ct_estado` VARCHAR(2) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `parica_db`.`materia_colaborador` (
  `mc_id` INT(5) ZEROFILL NOT NULL AUTO_INCREMENT COMMENT '',
  `mc_ma_id` INT(5) ZEROFILL NOT NULL COMMENT '',
  `mc_co_id` INT(5) ZEROFILL NOT NULL COMMENT '',
  PRIMARY KEY (`mc_id`, `mc_ma_id`, `mc_co_id`)  COMMENT '',
  INDEX `fk_materia_has_colaborador_colaborador1_idx` (`mc_co_id` ASC)  COMMENT '',
  INDEX `fk_materia_has_colaborador_materia1_idx` (`mc_ma_id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `parica_db`.`boletim` (
  ...
  `bo_n1` DECIMAL(2,2) NULL COMMENT '',
  `bo_n2` DECIMAL(2,2) NULL COMMENT '',
  `bo_n3` DECIMAL(2,2) NULL COMMENT '',
  `bo_n4` DECIMAL(2,2) NULL COMMENT '',
  `bo_f1` DECIMAL(2,2) NULL COMMENT '',
  `bo_f2` DECIMAL(2,2) NULL COMMENT '',
  `bo_f3` DECIMAL(2,2) NULL COMMENT '',
  `bo_f4` DECIMAL(2,2) NULL COMMENT '',
  `bo_ma_id` INT(5) ZEROFILL NOT NULL COMMENT '',
  `bo_al_id` INT(6) ZEROFILL NOT NULL COMMENT '',
  PRIMARY KEY (`bo_id`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `parica_db`.`materia_turma` (
  `mt_id` INT(5) ZEROFILL NOT NULL AUTO_INCREMENT COMMENT '',
  `mt_ma_id` INT(5) ZEROFILL NOT NULL COMMENT '',
  `mt_tu_id` INT(5) ZEROFILL NOT NULL COMMENT '',
  PRIMARY KEY (`mt_id`, `mt_ma_id`, `mt_tu_id`)  COMMENT '',
  INDEX `fk_materia_has_turma_turma1_idx` (`mt_tu_id` ASC)  COMMENT '',
  INDEX `fk_materia_has_turma_materia1_idx` (`mt_ma_id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `parica_db`.`declaracoes` (
  `dc_id` INT(5) ZEROFILL NOT NULL AUTO_INCREMENT COMMENT '',
  `dc_nome` VARCHAR(45) NULL COMMENT '',
  `dc_text` TEXT NULL COMMENT '',
  PRIMARY KEY (`dc_id`)  COMMENT '')
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `parica_db`.`aluno_turma`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `parica_db`.`aluno_turma` (
  `at_id` INT(5) ZEROFILL NOT NULL AUTO_INCREMENT COMMENT '',
  `at_al_id` INT(6) ZEROFILL NOT NULL COMMENT '',
  `at_tu_id` INT(5) ZEROFILL NOT NULL COMMENT '',
  PRIMARY KEY (`at_id`, `at_al_id`, `at_tu_id`)  COMMENT '',
  INDEX `fk_aluno_has_turma_turma1_idx` (`at_tu_id` ASC)  COMMENT '',
  INDEX `fk_aluno_has_turma_aluno1_idx` (`at_al_id` ASC)  COMMENT '',
  CONSTRAINT `fk_aluno_has_turma_aluno1`
    FOREIGN KEY (`at_al_id`)
    REFERENCES `parica_db`.`aluno` (`al_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_aluno_has_turma_turma1`
    FOREIGN KEY (`at_tu_id`)
    REFERENCES `parica_db`.`turma` (`tu_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
